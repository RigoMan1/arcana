...
const testPrompt = `Moderate content, including key points with some detail. Balances the use of words to provide clarity without unnecessary detail. Use simple and straightforward language, avoiding complex terms or jargon to ensure clarity and accessibility.`;
